...
// article이라는 인풋 데이터를 받아서 
// title, link 즉 제목과 인터넷 링크를 분리하여 
// listItem 내부의 하위 className, append(anchor)
// 두 하위 객체를 통해 데이터를 출력한다.
...
// 상위 뉴스를 렌더링하는 함수입니다.
// 사전에 만든 createSpinner 함수와 
// createTopNewsElement 함수를 사용해서 실제적인 업무지시를 내린다.
