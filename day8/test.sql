...
CREATE TABLE `deletedmembertbl` (
  `memberID` char(8) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `mebmerName` char(5) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `memberAddress` char(20) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
INSERT INTO `deletedmembertbl` VALUES ('Dang','당탕이','경기도 부천시 중동','2023-10-30');
...
CREATE TABLE `indextbl` (
  `first_name` varchar(14) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `last_name` varchar(16) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
CREATE TABLE `membertbl` (
  `memberID` char(8) COLLATE utf8mb3_unicode_ci NOT NULL,
  `memberName` char(5) COLLATE utf8mb3_unicode_ci NOT NULL,
  `memberAddress` char(20) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
INSERT INTO `membertbl` VALUES ('Ezreal','완상이','경기도 김포시 걸포동'),('Han','한주연','인천 남구 주안동'),('Jae','지운이','서울 은평구 증산동'),('Sang','상달이','경기도 성남시 분당구');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_deleteMemberTBL` AFTER DELETE ON `membertbl` FOR EACH ROW begin
...
CREATE TABLE `producttbl` (
  `productName` char(4) COLLATE utf8mb3_unicode_ci NOT NULL,
  `cost` int NOT NULL,
...
INSERT INTO `producttbl` VALUES ('냉장고',145,'2020-03-05','대우',22),('세탁기',120,'2020-12-25','LG',3),('컴퓨터',200,'2020-01-01','삼성',17);
...
-- Dump completed on 2023-10-30 17:36:02
