...
function onUserShoot(shootType) {
  ...
  if (shotsLeft === 0) {
    ...
    location.reload();    // 잔여 경기가 0이 되는 순간 자동으로 경기 리셋
  }
}
...
function resetGame(){
    ...
    // UI 초기화
    shotsLeftElem = document.getElementById('shots-left');
    userScoreElem = document.getElementById('user-score');
    comScoreElem = document.getElementById('computer-score')
